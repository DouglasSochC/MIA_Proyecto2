...
export class STecnicoService {
  ...
  InsertTecnico(nombre:string,fecha_nacimiento:string,link_fotografia:string,id_pais_tecnico:number,id_estado_tecnico:number,id_equipo:number,fecha_inicial:string){    
  ...
  UpdateTecnico(id_tecnico:number, nombre:string,fecha_nacimiento:string,link_fotografia:string,id_pais_tecnico:number,id_estado_tecnico:number){
    const url = "http://localhost:3000/updateTecnico";
    return this.http.put(url, 
    {
      "id_tecnico": id_tecnico,
      "nombre": nombre,
